...
let subu r1 r2 r3 = ins "subu %s, %s, %s" r1 r2 r3
...
let xori r1 r2 i  = ins "xori %s, %s, %d" r1 r2 i

let sll  r1 r2 r3 = ins "sll %s, %s, %d"  r1 r2 r3
let srl  r1 r2 r3 = ins "srl %s, %s, %d"  r1 r2 r3
  
let seq  r1 r2 r3  = ins "seq %s, %s, %s"  r1 r2 r3
let sne  r1 r2 r3  = ins "sne %s, %s, %s"  r1 r2 r3
let slt  r1 r2 r3  = ins "slt %s, %s, %s"  r1 r2 r3
let sltu  r1 r2 r3 = ins "sltu %s, %s, %s"  r1 r2 r3
